...
build/artifacts/ui-previewer-button.xpi: build/firefox/manifest.json $(FIREFOX_TARGET_JS) $(FIREFOX_ICONS) build/firefox/src/options/index.html
	@mkdir -p $(@D)
...
build/artifacts/ui-previewer-button.zip: build/chrome/manifest.json $(CHROME_TARGET_JS) $(CHROME_ICONS) build/chrome/src/options/index.html
	@mkdir -p $(@D)
...
safari: build/artifacts/ui-previewer-button.safariextension/Info.plist $(SAFARI_TARGET_JS) $(SAFARI_ICONS) build/artifacts/ui-previewer-button.safariextension/src/options/index.html build/artifacts/ui-previewer-button.safariextension/src/global.html
...
icons: sketchtool/bin/sketchtool icons/icon.sketch
